...
def setup_config3():
    ...
    failure = {
        "Xt": 2860.0e6,  # 纵向拉伸强度 pa 2860.0e6, 2180.0e6
        "Xc": 1450.0e6,  # 纵向压缩强度 pa 1450.0e6, 1200.0e6
        "Yt": 81.0e6,  # 横向拉伸强度 pa 81.0e6, 60.0e6
        "Yc": 170.0e6,  # 横向压缩强度 pa  不能确定 doubao 170.0e6, 140.0e6
        "S12": 136.0e6,  # 面内剪切强度 pa
        "S13": 136.0e6,  # 横向剪切强度 pa  不能确定
        "S23": 86.9e6,  # 横向剪切强度 pa
    }
